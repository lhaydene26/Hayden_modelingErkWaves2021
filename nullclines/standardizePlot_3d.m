function [] = standardizePlot_3d(mygcf,mygca,printName)
    % This function standardizes plot3 plots
    scaleFactor = 5;

    ax = mygca;
    ax.XLabel.FontSize = 7*scaleFactor;
    ax.YLabel.FontSize = 7*scaleFactor;
    ax.FontSize = 6*scaleFactor;
    ...
    set(gca,'Position',[0.2 0.25 0.7 0.7]);
