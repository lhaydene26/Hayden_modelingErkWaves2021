...
% with the script: analyze_con_dep_model_ErkInhib.m
...
t_washout = number; % time at which the heatshock starts
washout_duration = 10; % how long the heatshock lasts
...
file_name = sprintf('con_dep_ErkInhib_%d.txt',number);
